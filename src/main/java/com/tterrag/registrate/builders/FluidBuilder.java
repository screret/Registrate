...
public class FluidBuilder<TSource extends BaseFlowingFluid, TFlowing extends BaseFlowingFluid, P> extends AbstractBuilder<Fluid, TSource, P, FluidBuilder<TSource, TFlowing, P>> {
     ...
     */
    public static <P> FluidBuilder<BaseFlowingFluid.Source, BaseFlowingFluid.Flowing, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture) {
        return create(owner, parent, name, callback, stillTexture, flowingTexture, FluidBuilder::defaultFluidType, BaseFlowingFluid.Source::new, BaseFlowingFluid.Flowing::new);
    }
     ...
     * @see #create(AbstractRegistrate, Object, String, BuilderCallback, ResourceLocation, ResourceLocation, FluidTypeFactory, NonNullFunction, NonNullFunction)
     */
    public static <P> FluidBuilder<BaseFlowingFluid.Source, BaseFlowingFluid.Flowing, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture, FluidTypeFactory typeFactory) {
        return create(owner, parent, name, callback, stillTexture, flowingTexture, typeFactory, BaseFlowingFluid.Source::new, BaseFlowingFluid.Flowing::new);
    }
     ...
     * @see #create(AbstractRegistrate, Object, String, BuilderCallback, ResourceLocation, ResourceLocation, FluidTypeFactory, NonNullFunction, NonNullFunction)
     */
    public static <P> FluidBuilder<BaseFlowingFluid.Source, BaseFlowingFluid.Flowing, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture, NonNullSupplier<FluidType> fluidType) {
        return create(owner, parent, name, callback, stillTexture, flowingTexture, fluidType, BaseFlowingFluid.Source::new, BaseFlowingFluid.Flowing::new);
    }
     ...
     * @return A new {@link FluidBuilder} with reasonable default data generators.
     */
    public static <TSource extends BaseFlowingFluid, TFlowing extends BaseFlowingFluid, P> FluidBuilder<TSource, TFlowing, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture,
     ...
     */
    public static <TSource extends BaseFlowingFluid, TFlowing extends BaseFlowingFluid, P> FluidBuilder<TSource, TFlowing, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture,
                                                                                                                                       FluidTypeFactory typeFactory, NonNullFunction<BaseFlowingFluid.Properties, TSource> sourceFactory, NonNullFunction<BaseFlowingFluid.Properties, TFlowing> flowingFactory) {
     ...
     * @return A new {@link FluidBuilder} with reasonable default data generators.
     */
    public static <TSource extends BaseFlowingFluid, TFlowing extends BaseFlowingFluid, P> FluidBuilder<TSource, TFlowing, P> create(
    ...
    private final NonNullFunction<BaseFlowingFluid.Properties, ? extends TSource> sourceFactory;
    private final NonNullFunction<BaseFlowingFluid.Properties, ? extends TFlowing> flowingFactory;
    ...
    public FluidBuilder(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture, FluidTypeFactory typeFactory,
                        NonNullFunction<BaseFlowingFluid.Properties, ? extends TSource> sourceFactory, NonNullFunction<BaseFlowingFluid.Properties, ? extends TFlowing> flowingFactory) {
        super(owner, parent, name, callback, Registries.FLUID);
     ...
     * @return this {@link FluidBuilder}
     */
    public FluidBuilder<TSource, TFlowing, P> fluidProperties(NonNullConsumer<BaseFlowingFluid.Properties> cons) {
    ...
    private BaseFlowingFluid.Properties makeProperties() {
        BaseFlowingFluid.Properties ret = new BaseFlowingFluid.Properties(fluidType, asSupplier(), flowingFluid);
    ...
    private FluidType.Properties makeTypeProperties() {
        ...
        Optional<RegistryEntry<Block, Block>> block = getOwner().getOptional(getName(), Registries.BLOCK);
    ...
    public FluidEntry<TSource> register() {
        ...
        if (this.fluidType != null) {
            ...
            if (this.registerType) {
                getOwner().simple(this, getName(), NeoForgeRegistries.Keys.FLUID_TYPES, this.fluidType);
            }
        } else {
        ...
        getCallback().accept(flowingName, Registries.FLUID, (FluidBuilder) this, flowingFluid);

        return (FluidEntry<TSource>) super.register();
    }

    @Override
    protected RegistryEntry<Fluid, TSource> createEntryWrapper(DeferredHolder<Fluid, TSource> delegate) {
